  ...
  const handleNoteAction = (action, noteId) => {
    switch (action) {
      case "Edit":
        ...
        break;
      case "Detail":
        alert(`Note Details: ${notes.find(note => note.id === noteId)?.title}`);
        break;
      case "Delete":
        setNotes(notes.filter(note => note.id !== noteId));
        break;
    ...
    <>
      ...
      <div className="d-flex">
        <div className="sidebar-left">
          <i
            className="fas fa-home toggle-sidebar"
            onClick={toggleRightSidebar}
          />
          <i
            className="fas fa-clock toggle-sidebar"
            onClick={toggleRightSidebar}
          />
          <i
            className="fas fa-folder toggle-sidebar"
            onClick={toggleRightSidebar}
          />
          <i
          ...
          <div className="sidebar-bottom-icons">
            <i
              className="fas fa-gem toggle-sidebar"
              onClick={toggleRightSidebar}
            />
            <i
              className="fas fa-cog toggle-sidebar mb-3"
              onClick={toggleRightSidebar}
            />
            <i
        ...
        >
          ...
          <ul className="bottom-menu">
            <li>
              <i className="fas fa-cog mb-2"></i> Setting
            </li>
            <li>
